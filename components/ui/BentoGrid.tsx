  ...
  return (
    <div
      className={cn(
        ...
        {
          'md:col-span-3 md:row-span-1': id === 1, // First item spans 3 columns in the first row
          'md:col-span-3 md:row-span-1': id === 2, // Second item spans 3 columns in the first row
          'md:col-span-3 md:row-span-1': id === 3, // Third item spans 3 columns in the second row
        },
        className
      )}
      style={{
